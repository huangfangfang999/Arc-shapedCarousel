...
基于vue3+vite+pinia
弧形轮播路径：src/views/Arc-shapedCarousel.vue
不是vue项目，也可以参考其中的js，未使用任何插件，原生写法

![动图示例](https://github.com/huangfangfang999/Arc-shapedCarousel/blob/main/Arc-shapedCarousel/src/assets/arc-gif.gif)
